...
namespace MToon
{
    public static partial class Utils_CameraDistance
    {
        ...
        public const string PropShadeDistance = "_Distance";
        public const string PropShadeFocal = "_Focal";
        public const string PropShadeSize = "_Size";
