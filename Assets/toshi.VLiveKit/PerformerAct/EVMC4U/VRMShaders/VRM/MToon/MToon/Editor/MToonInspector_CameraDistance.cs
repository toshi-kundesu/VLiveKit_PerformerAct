...
namespace MToon
{
    public class MToonInspector_CameraDistance : ShaderGUI
    {
...
//        private MaterialProperty _outlineCullMode;
        ...
        private MaterialProperty _distance;
        private MaterialProperty _focal;
        private MaterialProperty _size;
...
//            _outlineCullMode = FindProperty(Utils.PropOutlineCullMode, properties);
            ...
            _distance = FindProperty(Utils_CameraDistance.PropShadeDistance, properties);
            _focal = FindProperty(Utils_CameraDistance.PropShadeFocal, properties);
            _size = FindProperty(Utils_CameraDistance.PropShadeSize, properties);
        ...
        private void Draw(MaterialEditor materialEditor, Material[] materials)
        {
            EditorGUI.BeginChangeCheck();
            {
                ...
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    materialEditor.ShaderProperty(_distance,new GUIContent("Distance",""));
                    materialEditor.ShaderProperty(_focal,new GUIContent("Focal", ""));
                    materialEditor.ShaderProperty(_size,new GUIContent("Size", ""));
                }
                EditorGUILayout.EndVertical();
                EditorGUILayout.Space();
